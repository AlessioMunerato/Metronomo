...
public class MainActivity extends Activity {
    ...
    private final short maxBpm = 210;
    ...
    private int[] idImage = {R.id.iV1, R.id.iV2, R.id.iV3, R.id.iV4, R.id.iV5, R.id.iV6, R.id.iV7, R.id.iV8};
    private int numBeat;
    ...
    private Handler getHandler() {
        return new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                int idIV = Integer.parseInt(message) - 1 ;
                ImageView dot = (ImageView) findViewById(idImage[idIV]);
                dot.setImageResource(R.drawable.circle_g);
                if(idIV == 0) idIV = 4;
                idIV--;
                dot = (ImageView) findViewById(idImage[idIV]);
                dot.setImageResource(R.drawable.circle_r);
                if(message.equals("1"))
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        numBeat = Integer.parseInt(beatSpinner.getSelectedItem().toString());
...
//    	metroTask = new MetronomeAsyncTask();
    ...
    private void resetDots(int num){
        ImageView temp;
        for(int i=0; i<num; i++){
            temp = (ImageView) findViewById(idImage[i]);
            if (i==0) {
                temp.setImageResource(R.drawable.circle_g);
            } else {
                temp.setImageResource(R.drawable.circle_r);
            }
        }
    }
